    ...
    <div class="row">
        ...
        <div>
            <div class="col-lg-12 col-sm-12 mx-auto">
                <!-- <h4 class="bg-secondary text-white text-center p-2 border rounded">INSURANCE AGENCY</h4>
                <div class="row mt-n2">
                    <h5 class="bg-primary text-white text-center p-2 border rounded">Non-Fleet Quote Sheet</h5>
                </div> -->
        ...
        <div class="row">
            <div id="tabContent" class="tab-content col-lg-12 mx-auto d-none d-md-block">
                <div id="tabII" class="row mt-2 tab-pane fade show active">
                    <div class="border rounded border-primary pb-2 ">
                        ...
                        <div class="row mt-2 gy-1">
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*Insured DOT#</div>
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Insured MC#</div>
                            <div class="col-lg-2 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Brokerage</div>
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">SSN</div>
                            <div class="col-lg-1 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">FEI</div>
                            <div class="col-lg-1 col-sm-6 pair">
                                <input type="number" id="Address" placeholder="xxxxxxxxxx" class="h-100 bg-white text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>


                            <div class="col-lg-2 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*Insured Name</div>
                            ...
                            <div class="col-lg-2 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*Owner's Name</div>
                            <div class="col-lg-4 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*Address</div>
                            <div class="col-lg-4 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*City</div>
                            <div class="col-lg-2 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*State</div>
                            <div class="col-lg-1 col-sm-6 pair">
                                <div class="h-100 bg-white text-primary border border-primary rounded-end p-1 text-center w-100">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*ZipCode</div>
                            <div class="col-lg-1 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Email</div>
                            <div class="col-lg-4 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">*Phone</div>
                            <div class="col-lg-2 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Fax</div>
                            <div class="col-lg-2 col-sm-6 pair">
                            ...
                            <div class="col-lg-4 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Other State Filings (Please provide ID #s if applicable)</div>
                            <div class="col-lg-5 col-sm-6 pair">
                            ...
                            <div class="col-lg-2 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Years in Business</div>
                            <div class="col-lg-1 col-sm-6 pair">
                            ...
                            <div class="col-lg-2 col-sm-6 bg-primary text-white rounded-start p-1 text-center">States Entered</div>
                            <div class="col-lg-5 col-sm-6 pair">
                            ...
                            <div class="col-lg-4 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Does the Insured do Doubles or Triples</div>
                            <div class="col-lg-1 col-sm-6 pair">
                                <div class="h-100 bg-white text-primary border border-primary rounded-end p-1 text-center w-100">
                                    <div class="switchToggle">
                            ...
                            <div class="col-lg-4 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Major Cities Driving into or Through</div>
                            <div class="col-lg-8 col-sm-6 pair">
                ...
                <div id="tabPCI" class="row mt-2 tab-pane fade">
                    <div class="border rounded border-primary">
                        ...
                        <div class="row mt-2">
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Year</div>
                            <div class="col-lg-1 col-sm-6 pair">
                                <input type="number" id="pciYear" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Company</div>
                            <div class="col-lg-1 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Losses</div>
                            <div class="col-lg-1 col-sm-6 pair">
                                <div class="h-100 bg-white text-primary border border-primary rounded-end p-1 text-center w-100">
                                    <div class="switchToggle">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Details</div>
                            <div class="col-lg-2 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 col-sm-6 bg-primary text-white rounded-start p-1 text-center">Driver Involved</div>
                            <div class="col-lg-1 col-sm-6 pair">
                            ...
                            <div class="col-lg-1 text-end pe-0 d-flex flex-column">
                ...
                <div id="tabDI" class="row mt-2 tab-pane fade">
                    <div class="border rounded border-primary">
                        ...
                        <div class="row">
                            ...
                            <div class="col p-0">
                                <input type="text" id="ownerDoesNotDrive" placeholder="Why not?" class="h-100 bg-white text-primary border border-primary rounded p-1 text-center w-100">
                            </div>
                        </div>
                        <div class="row p-2 pair gy-2">
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Driver Name</div>
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">DOB</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">License Number</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">State</div>
                            <div class="col-auto pair">
                                <div class="h-100 bg-white text-primary border border-primary rounded-end p-1 text-center w-100">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Date Hired</div>
                            <div class="col-auto pair">
                                <input type="date" id="diDateHired" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">CDL Years</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Accidents</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-1 text-end pe-0 d-flex flex-column float-end">
                ...
                <div id="tabVI" class="row mt-2 tab-pane fade">
                    <div class="border rounded border-primary">
                        ...
                        <div class="row p-2 pair gy-2">
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Year</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Type</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Make</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Gross Vehicle Weight</div>
                            <div class="col-auto pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Present Value</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Radius Miles</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Vehicle Identificaction Number</div>
                ...
                <div class="row mt-2 tab-pane fade" id="tabLiability">
                    <div class="border rounded border-primary">
                        ...
                        <div class="row pb-2 gy-2" id="primaryLiabilityGrp">
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Auto Liability Limits</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">UM</div>
                            <div class="col-1 pair">
                                <input type="number" id="viWeight" placeholder="xxxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">UIM</div>
                            <div class="col-1 pair">
                                <input type="number" id="viValue" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">PIP Coverage</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Med Pay</div>
                            <div class="col-1 pair">
                            ...
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Hired Car</div>
                            <div class="col-1 pair">
                                <input type="number" id="viValue" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Non-Owned</div>
                            <div class="col-1 pair">
                                <input type="number" id="viValue" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">GL Coverage</div>
                            <div class="col-1 pair">
                                <input type="number" id="viValue" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                            <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Other</div>
                            <div class="col-1 pair">
                                <input type="number" id="viValue" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                            </div>
                        </div>
                ...
                <div class="row mt-2 tab-pane fade" id="tabCargo">
                    <div class="border rounded border-primary">
                        <div class="fw-bold text-decoration-underline h4">Cargo</div>
                        <div id="cargoGrp">
                            <div class="row pb-2">
                                <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Maximum Cargo Limit</div>
                                <div class="col-1 pair">
                                    <input type="number" id="viYear" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                                </div>
                                <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Cargo Deductible</div>
                                <div class="col-1 pair">
                                    <input type="number" id="viYear" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                                </div>
                                <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Reefer Breakdown Deductible</div>
                                <div class="col-1 pair">
                                    <input type="number" id="viYear" placeholder="xxxxxxxx" class="bg-white h-100 text-primary border border-primary rounded-end p-1 text-center w-100">
                                </div>
                            </div>
                            <hr>
                            <div class="row pb-2">
                                <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Commodity Transport</div>
                                <div class="col-1 pair">
                                ...
                                <div class="col-auto bg-primary text-white rounded-start p-1 text-center">% of Total</div>
                                <div class="col-1 pair">
                                ...
                                <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Avg. Value per Truckload</div>
                                <div class="col-1 pair">
                                ...
                                <div class="col-auto bg-primary text-white rounded-start p-1 text-center">Max. Value per Truckload</div>
                                <div class="col-1 pair">
                ...
                <div class="row mt-2 tab-pane fade" id="tabPhysical">
                    <div class="border rounded border-primary">
